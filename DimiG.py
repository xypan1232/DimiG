...
def get_baseline_performance():
    predi_mirna_dis = {}
    adj, features, labels, idx_train, idx_val, idx_test, all_dis, new_mirna_disease, disease_miRNA_list = read_expression_data('data/GTEx_Analysis_v6p_RNA-seq_RNA-SeQCv1.1.8_gene_median_rpkm.gct.gz', data = 3)
    result_file = 'dislncrf-mir'
    dis_mirna_score, mirna_set = read_mirpd('data/miranda_full.tsv')
    #pdb.set_trace()
    disease_mirna_dict = {}
    print
    'disease'
    ...
    for dis, mirnas in disease_mirna_dict.iteritems():
        ...
        for mirna in mirnas:
            ...
            key = (dis, mirna)
            if key in dis_mirna_score:
                labels.append(1)
                probs.append(dis_mirna_score[key])
